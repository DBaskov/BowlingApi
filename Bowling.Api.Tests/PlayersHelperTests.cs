...
namespace Bowling.Api.Tests
{
    ...
    public class PlayersHelperTests
    {
        ...
        public async Task UpdateScoreStrikeTest()
        {
            ...
            Assert.AreEqual(result.ResultList[0][1], -1);
        }
        ...
        public async Task UpdateScoreShotAfterStrikeTest()
        {
            ...
            var oldTotalScore = 10;
            var oldRunningTotalList = new List<int> { 10 };
            var oldFrame = new List<int>() { 10, -1 };
        ...
        public async Task UpdateScoreSecondShotAfterStrikeTest()
        {
            ...
            Assert.AreEqual(result.TotalScore, (10 + oldFrames[1][0] + numPins) + oldFrames[1][0] + numPins);
            Assert.AreEqual(result.RunningTotalList[0], 10 + oldFrames[1][0] + numPins);
        ...
        public async Task UpdateScoreSecondInRowStrikeTest()
        {
            ...
            Assert.AreEqual(-1, result.ResultList[1][1]);
        }
        ...
        {
            var resultList = new List<List<int>>() { new List<int>() { 2, 4 }, new List<int>() { 5, 3 } };
        ...
        {
            var resultList = new List<List<int>>() { new List<int>() { 4, 10 }, new List<int>() { 5 } };
